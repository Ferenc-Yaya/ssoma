...
public interface EmpresaMapper {
    ...
    EmpresaDTO toDTO(EmpresaEntity empresa);

    List<EmpresaDTO> toDTOList(List<EmpresaEntity> empresas);
    ...
    EmpresaEntity toEntity(CreateEmpresaDTO dto);
    ...
    @Mapping(target = "contactos", ignore = true)
    @Mapping(target = "tipo", ignore = true)
    void updateEntityFromDTO(CreateEmpresaDTO dto, @MappingTarget EmpresaEntity empresa);
}